...
# Вместо введения
Данная инструкция позволит вам самостоятельно настроить Xray с протоколом VLESS на своём VPS-сервере. Инструкция основывается на статьях, указанных в разделе "[Используемые источники](#Используемые%20источники)". У данного решения есть несколько плюсов:
...
- [p] ***Большая устойчивость и незаметность***
...
- [p] ***Устойчивость к выявлению на долго (скорее всего)***
...
- [p] ***Вы узнаете много нового и получите ценный опыт (надеюсь)***
  В разделе теории вы сможете кратко ознакомиться с технической стороной вопроса и узнать как это работает, а благодаря ссылкам, приведённым в разделе "Используемые источники", вы сможете узнать много нового о других современных технологиях и способах обхода обнаружения трафика! Учитывая, что операционная система Linux (AstraLinux) может стать повсеместно распространена в случае усиления санкций, это отличный способ познакомиться с ней немного ближе)

Однако есть и минусы:
- [c] ***Деньги...***
  Вам потребуется арендовать зарубежный VPS-сервер, что потребует от вас 200-500 р в месяц, но оно того стоит!
...
*Статья написана в приложении для заметок и ведения своей базы знаний [Obsidian](https://obsidian.md/) v1.8.9 (с использованием темы [Minimal](https://github.com/kepano/obsidian-minimal)) и затем конвертирована в pdf. Cхемы нарисованы с помощью чудного плагина [Excalidraw](obsidian://show-plugin?id=obsidian-excalidraw-plugin) v2.9.2.*
*Желающие могут скачать эту инструкцию с [Github](https://github.com/EmptyLibra/Configure-Xray-with-VLESS-Reality-on-VPS-server) в исходном виде, написанном на языке Markdown (файл формата .md), а также большую часть упомянутых источников.
...
![|515x315](resources/Схема_vps.png)
...
4. Все самые часто встречающиеся пароли давно находятся в общедоступных или слитых базах данных. Если вы будете использовать для сервера не уникальный/плохо сгенерированный пароль, рано или поздно вы лишитесь сервера.
...
>      - "Dest (Target)": самое интересное, это домен (сайт), под который вы будете маскироваться. По умолчанию панель предлагает маскировку под yahoo.com и www.yahoo.com с переадресацией на yahoo.com:443, но лучше выбрать какой-нибудь другой домен, как описано ранее;
...
- [i] [Статьи](https://habr.com/ru/articles/727868/) пользователя Deleted-user (раньше MiraclePtr, видимо, его банят периодически) на habr.com от 2023г о различных, устойчивых к блокировке протоколов и их настройке на собственном сервере (тут много теории и технических аспектов, крайне рекомендую, если интересует, как всё устроено изнутри). Весь его цикл состоит из 15 статей, вот ссылки на все:
	- [Раз](https://habr.com/ru/articles/710980/) ([html](1_Интернет-цензура%20и%20обход%20блокировок_%20не%20время%20расслабляться%20_%20Хабр%20(02.05.2024).html), [комментарии](1_Интернет-цензура%20и%20обход%20блокировок：%20не%20время%20расслабляться%20_%20Комментарии%20_%20Хабр%20(24.11.2024%2013：02：26).html)) - краткая эволюция протоколов, устойчивых к блокировкам и способов их выявления;
	- [Два](https://habr.com/ru/articles/727868/) ([html](2_Современные%20технологии%20обхода%20блокировок_%20V2Ray,%20XRay,%20XTLS,%20Hysteria,%20Cloak%20и%20все-все-все%20_%20Хабр%20(02.05.2024).html), [комментарии](2_Современные%20технологии%20обхода%20блокировок%20_%20Комментарии%20_%20Хабр%20(24.11.2024).html)) - современные способы обхода блокировок и их происхождение (V2Ray, XRay, XTLS, Hysteria, Cloak...);
	- [Три](https://habr.com/ru/articles/728696/) ([html](3_Программы-клиенты%20для%20протоколов%20недетектируемого%20обхода%20блокировок%20сайтов_%20V2Ray_XRay%20(02.05.2024).html), [комментарии](3_Программы-клиенты%20для%20протоколов%20недетектируемого%20обхода%20блокировок%20сайтов_Комментарии.html)) - обзор программ-клиентов для связи с сервером по защищённым протоколам;
	- [Четыре](https://habr.com/ru/articles/728836/) ([html с комментариями](4_Обход%20блокировок_%20настройка%20сервера%20XRay%20для%20Shadowsocks-2022%20и%20VLESS%20с%20XTLS-Vision...%20_%20Хабр%20(02.05.2024).html)) - настройка сервера XRay для Shadowsocks-2022 и VLESS-XTLS-Vision;
	- [Пять](https://habr.com/ru/articles/731608/) ([html](5_Bleeding-edge%20обход%20блокировок%20с%20полной%20маскировкой_%20настраиваем%20сервер%20и%20клиент%20XRay%20с%20XTLS-Reality(02.05.2024).html), [комментарии](5_Bleeding-edge%20обход%20блокировок%20с%20полной%20маскировкой：%20настраиваем%20сервер%20и%20клиент%20XRay%20с%20XTLS-Reality_Комментарии.html)) - настройка сервера и клиента Xray с VLESS-XTLS-Reality;
	- [Шесть](https://habr.com/ru/articles/735536/) ([html](6_3X-UI_%20Shadowsocks-2022%20&%20XRay%20(XTLS)%20сервер%20с%20простой%20настройкой%20и%20приятным%20интерфейсом%20_%20Хабр%20(02.05.2024).html), [комментарии](6_3X-UI：%20Shadowsocks-2022%20&%20XRay%20(XTLS)%20сервер%20_%20Комментарии%20_%20Хабр%20(28.02.2024).html)) - настройка сервера через графическую панель 3X-UI;
	- [Семь](https://habr.com/ru/articles/761798/) ([html](7_Особенности%20проксирования%20через%20CDN_Websocket_gRPC%20для%20обхода%20блокировок%20_%20Хабр%20(02.05.2024).html), [комментарии](7_Особенности%20проксирования%20через%20CDN_Websocket_gRPC%20_%20Комментарии%20_%20Хабр%20(25.02.2024).html)) - настройка подключения к серверу через CDN (Websocket, grpc);
	- [Восемь](https://habr.com/ru/articles/770400/) ([html](8_FAQ%20по%20Shadowsocks_XRay_XTLS_Reality_Nekobox_etc.%20для%20обхода%20блокировок%20_%20Хабр%20(02.05.2024).html), [комментарии](8_FAQ%20по%20Shadowsocks_XRay_XTLS_Reality_Nekobox_etc.%20для%20обхода%20блокировок%20_%20Комментарии%20_%20Хабр%20(28.02.2024).html)) - частые вопросы/ответы по прошлым статьям и комментариям;
	- [Девять](https://habr.com/ru/articles/774838/) ([html](9_XRay%20(с%20VLESS_XTLS)_%20проброс%20портов,%20реверс-прокси,%20и%20псевдо-VPN%20_%20Хабр%20(02.05.2024).html), [комментарии](9_XRay%20(с%20VLESS_XTLS)：%20проброс%20портов,%20реверс-прокси,%20и%20псевдо-VPN%20_%20Комментарии%20_%20Хабр%20(25.02.2024).html)) - получение доступа к корпоративной сети с помощью Xray (проброс портов, реверс-прокси);
	- [Десять](https://habr.com/ru/articles/776256/) ([html](10_OpenConnect_%20недетектируемый%20VPN,%20который%20вам%20понравится%20_%20Хабр%20(02.05.2024).html), [комментарии](10_OpenConnect：%20недетектируемый%20VPN,%20который%20вам%20понравится%20_%20Комментарии%20_%20Хабр%20(25.02.2024).html)) - недектируемый VPN (именно VPN, а не прокси) OpenConnect и его настройка;
	- [Одиннадцать](https://habr.com/ru/articles/777656/) ([html](11_GOST_%20швейцарский%20нож%20для%20туннелирования%20и%20обхода%20блокировок%20_%20Хабр%20(02.05.2024).html), [комментарии](11_GOST：%20швейцарский%20нож%20для%20туннелирования%20и%20обхода%20блокировок%20_%20Комментарии%20_%20Хабр%20(01.03.2024).html)) - GOST: швейцарский нож для туннелирования и обхода блокировок;
	- [Двенадцать](https://habr.com/ru/articles/778134/) ([html](12_Domain%20fronting%20для%20чайников,%20и%20как%20его%20использовать%20для%20обхода%20блокировок%20_%20Хабр%20(02.05.2024).html), [комментарии](12_Domain%20fronting%20для%20чайников,%20и%20как%20его%20использовать%20для%20обхода%20блокировок%20_%20Комментарии%20_%20Хабр%20(01.03.2024).html)) - Domain fronting для чайников, и как его использовать для обхода блокировок;
	- [Тринадцать](https://habr.com/ru/articles/799751/) ([html](13_Надежный%20обход%20блокировок%20в%202024_%20протоколы,%20клиенты%20и%20настройка%20сервера%20_%20Хабр%20(25.09.2024).html)) - подробная статья с полной настройкой VPS сервера под неблокируемые протоколы 2024;
	- [Четырнадцать](https://habr.com/ru/articles/834290/) ([html](14_Малоизвестные%20фичи%20XRay,%20о%20которых%20невозможно%20молчать%20_%20Хабр%20(06.09.2024).html)) - Малоизвестные фичи XRay, о которых невозможно молчать;
	- [Пятнадцать](https://habr.com/ru/articles/837904/) ([html](15_Matrix_%20децентрализованные%20открытые%20мессенджеры%20с%20E2E-шифрованием%20(31.10.2024).html)) - Matrix: децентрализованные открытые мессенджеры с E2E-шифрованием.
...
- [i] [Статья](https://habr.com/ru/articles/785186/) ([html](1_ХАБР_Личный%20прокси%20для%20чайников_%20универсальный%20обход%20цензуры%20с%20помощью%20VPS,%203X-UI,%20Reality_CDN%20и%20Warp%20_%20Хабр%20(19.10.2024%2021_58_28).html)) пользователя quakin на habr.com с инструкцией по настройке VLESS-XTLS-Reality через панель 3X-UI, CDN и прочее.
- [i] [Инструкция](https://github.com/XTLS/Xray-core/discussions/3518) ([html](Настройка%20VLESS_TCP_%20REALITY_VISION%20_%20uTLS_XTLS_Xray-core_Discussion.html)) из обсуждения Xray на Github по настройке VLESS XTLS-Reality с подробным разбором механизмов его работы.
- [i] [Инструкция](https://habr.com/ru/articles/791724/) ([html](Как%20стать%20VPN%20провайдером%20за%20один%20вечер%20_%20Хабр%20(12.07.2024).html)) от пользователя 271828 с Хабр с автоматическим скриптом для установки, в том числе с Docker. 
...
- [i] Простенькая [инструкция](https://pikabu.ru/story/nastroyka_luchshikh_vpn_protokolov_vless_s_xtlsreality_na_servere_xray_s_ustanovkoy_cherez_3xui_panel_10782662) ([html](Настройка%20лучших%20VPN%20протоколов!%20VLESS%20с%20XTLS-Reality%20на%20сервере%20XRay%20с%20установкой%20через%203X-UI%20панель%20_%20Пикабу%20(19.10.2024).html)) с Пикабу о настройке Vless-xtls-Reality через 3X-UI (есть проблемы с безопасностью).
